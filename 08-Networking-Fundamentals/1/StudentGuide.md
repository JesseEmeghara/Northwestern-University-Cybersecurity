 ...
 **COMMENT: DID YOU INTEND TO REPLACE THIS IMAGE WITH GLIFFY1-NEW.PNG?**
...
- Hover your mouse over some of the devices and shapes. Their names should display.
  ...
  - We've covered several devices here, such as routers, switches, computers, and firewalls.
...
Let's start by adding the required devices for our LAN:
  ...
  - Drag the connecter from the device to the switch.
  ...
  - The router needs to connect to the switch. Add a connecting line between those devices.
